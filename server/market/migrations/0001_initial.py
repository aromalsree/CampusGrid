            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("BUY", "Wanted to Buy"),
                            ("BORROW", "Wanted to Borrow / Rent"),
                            ("SERVICE", "Seeking Tutoring / Academic Service"),
                        ],
                        db_index=True,
                        default="BUY",
                        max_length=20,
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("URGENT", "Needed ASAP (Within 24-48 Hours)"),
                            ("MODERATE", "Needed This Week"),
                            ("FLEXIBLE", "Flexible / Anytime This Semester"),
                        ],
                        db_index=True,
                        default="URGENT",
                        max_length=20,
